...
public class PlayerOffense : MonoBehaviour {
    ...
    private float EBlastSpeed = 10f;
    private bool EBHPLifeSteal = false;
    private bool EBMPLifeSteal = false;
    ...
    void ShootEnergyProjectile()
    {
        print("Test");
        var bullet = (GameObject)Instantiate(EnergyBullet,
       EnergyBulletSpawn.position,
       EnergyBulletSpawn.rotation);
